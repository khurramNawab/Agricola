...
const faqs = [
  {
    ...
    a: "AgriCola works directly with trusted agrarian cooperatives and heritage grower communities. Furthermore, every batch brought to our FSSAI-compliant certified facilities undergoes independent laboratory testing for purity, pesticide residues, and heavy metals before packaging.",
  },
  {
